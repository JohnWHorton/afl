...
CREATE TABLE IF NOT EXISTS prediction (
  ...
  predictionjson longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
...
INSERT INTO prediction (id, email, predictionjson, amount, datecreated) VALUES
...
union 
select prediction.email AS email,'Prediction' AS transtype,prediction.amount AS amount,prediction.datecreated AS `Date` from prediction
union
