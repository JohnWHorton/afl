...
var weblang = "en";
	...
	<!-- <div id="fmdata" style="display: block;"> -->
		...
		<div class="container col-md-12">
			<form >
				<div class="form-check-inline" style="width: 100%;">
					...
					<button class="btn btn-sm btn-outline-secondary active" data-toggle="button"  aria-pressed="true" autocomplete="off" id="btn-social"><i class="fas fa-share-alt-square"></i> <?php echo $lang[3]; ?></button>
		...
		<div class="container col-md-12" style="width: 100%; height: 100%; margin-left: 5px;">
				<!-- <?php echo $lang[7]; ?>:&nbsp;&nbsp;</b><span id="moncnt"></span>&nbsp;&nbsp;<?php echo $lang[8]; ?>:&nbsp;&nbsp;<span id="maxlastrun"></span> -->
				<button class="btn btn-secondary btn-sm" onclick="showSchedule();"><i class="far fa-clock"></i>  <?php echo $lang[9]; ?></button>
			...
			<div class="modal-content col-sm-12">
				...
				<div class="modal-body ">
					<form id="addsrcform" class="form" action="">
					  ...
					  <div style="display:flex; flex-direction: row; text-align: left">
						<label for="fmschedule" style="min-width: 140px; padding: 5px;"><?php echo $lang[48]; ?>:</label>
					  ...
					  <br><br>
					  <center><button class="btn btn-sm btn-secondary" onclick="doAddSource();" style="min-width: 100px;"><?php echo $lang[10]; ?></button></center>
					</form>
				</div>
		...
		<div class="modal-dialog w-50">
			<div class="modal-content col-sm-12">
				...
				<div class="modal-body ">
					  ...
					  <center><button class="btn btn-sm btn-secondary" onclick="doSaveView();" style="min-width: 100px;"><?php echo $lang[11]; ?></button></center>
		...
		<div class="modal-dialog w-100">
			<div class="modal-content col-sm-12">
				...
				<div class="modal-header text-center" style="font-size: 0.8rem; margin-top: 10px;">
					<h5 class="modal-title w-100" style="text-align: center">Spider schedule</h5>
					<button class="btn btn-secondary btn-sm" data-dismiss="modal" style="padding: .05rem .3rem;"><?php echo $lang[21]; ?></button>
				</div>
				<!-- Modal body -->
