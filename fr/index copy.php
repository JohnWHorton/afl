		...
		<div class="modal-dialog w-100">
			<div class="modal-content col-sm-12">
				...
				<div class="modal-footer text-center" style="width: 480px;">
					<button type="button" class="btn btn-secondary btn-sm" onclick="doDeleteScedule();" id="modal-btn-yes">Oui</button>
					<button type="button" class="btn btn-secondary btn-sm" onclick="$('#myConfirm').modal('hide');"  id="modal-btn-no">Non</button>
				</div>
			</div>
		</div>
	</div>
				...
				<div class="modal-body ">
					<form id="uploadCSV" class="form" action="">
						<div class="form-group">
							<label for="sourceCSV">Sélectionnez un CSV à télécharger</label>
							<input type="file" class="form-control-file" id="sourceCSV">
							</br><p class="text-left">Remarque : les flux déjà existants seront ignorés. Seuls les nouveaux flux seront ajoutés.</p>
						</div>
