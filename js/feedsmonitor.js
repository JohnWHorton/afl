...
var myTheme = {
  palette: {
    // object
    pie: [
      // Key is chart type name, value is array of arrays
...
var fa_android =
  '<span style="color: #ffffff;"><center><i class="fab fa-android"></i></center></span>';
var fa_apple =
  '<span style="color: #ffffff;"><center><i class="fab fa-apple"></i></center></span>';
var fa_apps =
  '<span style="color: #bdbdb9;"><center><i class="fa fa-th"></i></center></span>';
var fa_instagram =
  '<span style="color: #808080; font-size: 36px;" title="Instagram"><center><i class="fab fa-instagram"></i></center></span>';
var fa_twitter =
  '<span style="color: #40beeb; font-size: 30px;" title="Twitter"><center><i class="fab fa-twitter"></i></center></span>';
var fa_facebook =
  '<span style="color: #4267b2; font-size: 30px;" title="Facebook"><center><i class="fab fa-facebook-f"></i></center></span>';
var fa_telegram =
  '<span style="color: #22b8f0; font-size: 30px;" title="Instagram"><center><i class="fab fa-telegram-plane"></i></center></span>';
var fa_viber =
  '<span style="color: #22b8f0; font-size: 30px;" title="Instagram"><center><i class="fab fa-viber"></i></center></span>';
var fa_vk =
  '<span style="color: #40beeb; font-size: 30px;"><center title="Telegram"><i class="fab fa-vk"></i></center></span>';
var fa_positive =
  '<span style="color: #71bf32;"><center><i class="fas fa-long-arrow-alt-up"></i></center></span>';
var fa_neutral =
  '<span style="color: #40beeb;"><center><i class="fas fa-minus"></i></center></span>';
var fa_negative =
  '<span style="color: #c94d51;"><center><i class="fas fa-long-arrow-alt-down"></i></center></span>';
var fa_rss =
  '<span style="color: #22b8f0;"><center><i class="fas fa-rss"></i></center></span>';
var fa_newscontent =
  '<span style="color: #22b8f0;"><center><i class="far fa-newspaper" style="color:white"></i></center></span>';
var fa_whatsapp =
  '<span style="color: #22b8f0;"><center><i class="fab fa-whatsapp"  style="color:green"></i></center></span>';
var fa_youtube =
...
function transformData() {
  for (i = 0; i < mydata.length; i++) {
    ...
    if (mydata[i].social_network.toLowerCase() == "twitter") {
      mydata[i].social_network = "<div>" + fa_twitter + "</div>";
    }
    if (mydata[i].social_network.toLowerCase() == "instagram") {
      mydata[i].social_network = "<div>" + fa_instagram + "</div>";
    }
    if (mydata[i].social_network.toLowerCase() == "facebook") {
      mydata[i].social_network = "<div>" + fa_facebook + "</div>";
    }
    if (mydata[i].social_network.toLowerCase() == "telegram") {
      mydata[i].social_network = "<div>" + fa_telegram + "</div>";
    }
    if (mydata[i].social_network.toLowerCase() == "viber") {
      mydata[i].social_network = "<div>" + fa_viber + "</div>";
    }

    mydata[i].pic_url =
      '<img src="' +
      mydata[i].pic_url +
      '" onerror="this.src=&quot;https://rogueeye.systems/images/twitterProfile.png&quot;" class="picture">';
    ...
    tmpdesc = "";
    if (
      typeof mydata[i].title !== "undefined" &&
      mydata[i].title &&
      mydata[i].title > ""
    ) {
      tmpdesc +=
        ...
        i +
        ')" style="padding: 10px 5px 5px 5px; width: 100%; height: 140px; overflow-x: hidden;"><strong>Title: </strong>' +
        mydata[i].title.replace(/(\r\n|\n|\r)/gm, "<br />") +
        "<br>";
    }
    if (
      typeof mydata[i].description !== "undefined" &&
      mydata[i].description &&
      mydata[i].description > ""
    ) {
      tmpdesc +=
        "<strong>Content: </strong>" +
        mydata[i].description.substr(0, 200) +
        " ...</div>";
    }
    ...
    if (mention && htags > "") {
      ...
      for (k = 0; k < ht.length; k++) {
        if (ht[k] !== " " && ht[k] !== "")
          mydata[i].tags +=
            '<button class="button tagbtns" style="outline: none;">' +
            ht[k] +
            "</button>";
      }
    } else {
      mydata[
        i
      ].tags = `<button class="button tagbtns" style="outline: none;">content</button>
    ...
    if (
      typeof mydata[i].like_count !== "undefined" &&
      mydata[i].like_count > "0"
    ) {
      mydata[i].engagements +=
        '<span style="float: left;" title="Likes"><i class="far fa-thumbs-up"></i><b> ' +
        mydata[i].like_count +
        "</b></span>";
    }
    if (
      typeof mydata[i].comment_count !== "undefined" &&
      mydata[i].comment_count > "0"
    ) {
      mydata[i].engagements +=
        '<span style="padding-right: 30px; float: right;"><i class="fas fa-retweet" title="Retweets"></i><b> ' +
        mydata[i].comment_count +
        "</b></span>";
    }
    mydata[i].engagements += "<br>";
    if (
      typeof mydata[i].retweet_count !== "undefined" &&
      mydata[i].retweet_count > "0"
    ) {
      mydata[i].engagements +=
        '<span style="float: left;"><i class="fas fa-retweet" title="Retweets"></i><b> ' +
        mydata[i].retweet_count +
        "</b></span>";
    }
    if (
      typeof mydata[i].shared_count !== "undefined" &&
      mydata[i].shared_count > "0"
    ) {
      mydata[i].engagements +=
        '<span style="padding-right: 30px; float: right;" title="shared"><i class="far fa-share-square"></i><b> ' +
        mydata[i].shared_count +
        "</b></span>";
    }
    ...
    if (mydata[i].sentiment == "Positive") {
      senticon =
        '<span style="color: #008000; font-size: 24px;"><i class="fas fa-smile"></i></span>';
    } else if (mydata[i].sentiment == "Negative") {
      senticon =
        '<span style="color: #DC3608; font-size: 24px;"><i class="fas fa-frown-open"></i></span>';
    } else {
      senticon =
        '<span style="color: #808080; font-size: 24px;"><i class="fas fa-meh"></i></span>';
    }

    let s = mydata[i].sentiment;
    if (winlocpath.includes("/fr")) {
      if (mydata[i].sentiment == "Neutral") {
        s = "Neutralité";
      }
      if (mydata[i].sentiment == "Positive") {
        s = "Positif";
    ...
    mydata[i].sentiment =
      '<span style="padding-left: 5px;" >' + senticon + " " + s + "</span>";
...
function showFullPost(i) {
  let tmpdesc = "";
  if (
    typeof rawdata[i].title !== "undefined" &&
    rawdata[i].title &&
    rawdata[i].title > ""
  ) {
    tmpdesc +=
      '<div style="text-align: left; padding: 10px 5px 5px 5px; width: 100%; height: 100%;"><strong>Title: </strong>' +
      rawdata[i].title.replace(/(\r\n|\n|\r)/gm, "<br />") +
      "<br>";
  }
  if (
    typeof rawdata[i].description !== "undefined" &&
    rawdata[i].description &&
    rawdata[i].description > ""
  ) {
    tmpdesc +=
      "<strong>Content: </strong>" +
      rawdata[i].description.replace(/(?:\r\n|\r|\n)/g, "<br>") +
      "</div>";
  }
  ...
  if (loadname == "") {
    ...
    for (i = 0; i < saveddata.length; i++) {
      if (saveddata[i].name == loadname) {
        if (
          (saveddata[i].social == 0 && fldtypes.social == true) ||
          (saveddata[i].social == 1 && fldtypes.social == false)
        ) {
          $("#btn-social").click();
        }
        if (
          (saveddata[i].websites == 0 && fldtypes.websites == true) ||
          (saveddata[i].websites == 1 && fldtypes.websites == false)
        ) {
          $("#btn-websites").click();
        }
        if (
          (saveddata[i].rss == 0 && fldtypes.rss == true) ||
          (saveddata[i].rss == 1 && fldtypes.rss == false)
        ) {
          $("#btn-rss").click();
        }
        if (
          (saveddata[i].forums == 0 && fldtypes.forums == true) ||
          (saveddata[i].forums == 1 && fldtypes.forums == false)
        ) {
          $("#btn-forums").click();
        }
        ...
        let subcats = saveddata[i].subcats
          .replace("[", "")
          .replace("]", "")
          .split(",");
        let tmp = [];
...
function doAddSource() {
  ...
  if (fmtype == "Sites Internet") {
    fmtype = "Websites";
  }
  if ($("#fmsource").val() != null) {
    fmsource = $("#fmsource").val();
  } else {
    fmsource = "";
  }
  if ($("#fmname").val() != null) {
  ...
  if ($("#fmschedule").val() != null) {
    fmschedule = $("#fmschedule").val();
  } else {
    fmschedule = "";
  }
  if ($("#fmhour").val() != null) {
  ...
  if ($("#fmday").val() != null) {
    fmday = $("#fmday").children("option:selected").val();
  } else {
    fmday = "";
  }
...
function doUpdateSource(id) {
  ...
  if ($("#fmsource2").val() != null) {
    fmsource = $("#fmsource2").val();
  } else {
    fmsource = "";
  }
  if ($("#fmname2").val() != null) {
  ...
  for (i = 0; i < topuserspertime.length; i++) {
    for (j = 0; j < topuserspertime[i].Networks.buckets.length; j++) {
      if (tmparr.includes(topuserspertime[i].Networks.buckets[j].key)) {
        datearr.push([
          topuserspertime[i].key_as_string.replace(" 00:00:00", ""),
          topuserspertime[i].Networks.buckets[j].doc_count,
          topuserspertime[i].Networks.buckets[j].key,
        ]);
        userexists = false;
...
function makeViewDropdown() {
  ...
  for (i = 0; i < saveddata.length; i++) {
    viewHTML +=
      '<option style="background-color: #000; color: #fff;">' +
      saveddata[i].name +
      "</option>";
  }
...
function doEditSource(id) {
  ...
  let typeopts = "";
  if (fmtype == "Social") {
    typeopts += "<option selected>Social</option>";
  } else {
    typeopts += "<option >Social</option>";
  }
  if (fmtype == "Websites") {
    typeopts += "<option  selected>Websites</option>";
  } else {
    typeopts += "<option >Websites</option>";
  }
  if (fmtype == "RSS") {
    typeopts += "<option  selected>RSS</option>";
  } else {
    typeopts += "<option >RSS</option>";
  }
  if (fmtype == "Forums") {
    typeopts += "<option  selected>Forums</option>";
  } else {
    typeopts += "<option >Forums</option>";
  }
  ...
  sourceHTML =
    `<div style="display:flex; flex-direction: row; text-align: left">
						<label for="fmtype2" style="min-width: 140px; padding: 5px; outline: transparent;">` +
    langarr[22] +
    `:</label>
  ...
  sourceHTML +=
    `</select>
					  ...
					  <div style="display:flex; flex-direction: row; text-align: left">
						<label for="fmsource2" style="min-width: 140px; padding: 5px;">` +
    langarr[23] +
    `:</label>
						<input class="w-20" type="text" class="form-control" id="fmsource2" required value="` +
    aSrc.fmsource +
    `">
					  </div>
					  <div style="display:flex; flex-direction: row; text-align: left">
						<label for="fmname2" style="min-width: 140px; padding: 5px;">` +
    langarr[24] +
    `:</label>
						<input class="w-20" type="text" class="form-control" id="fmname2" required value="` +
    aSrc.fmname +
    `">
					  </div>
					  <div style="display:flex; flex-direction: row; text-align: left">
						<label for="fmurl2" style="min-width: 140px; padding: 5px;">` +
    langarr[25] +
    `:</label>
						<input class="w-20" style="min-width: 400px;" type="text" class="form-control" id="fmurl2" required value="` +
    aSrc.fmurl +
    `">
					  </div>
					  <div style="display:flex; flex-direction: row; text-align: left">
						<label for="fmschedule2" style="min-width: 140px; padding: 5px;">` +
    langarr[26] +
    `:</label>
  ...
  sourceHTML +=
    `<div style="display:flex; flex-direction: row; text-align: left">
		<label for="fmhour2" style="min-width: 140px; padding: 5px;">` +
    langarr[47] +
    `:</label>
  ...
  sourceHTML +=
    `<div style="display:flex; flex-direction: row; text-align: left">
					<label for="fmday2" style="min-width: 140px; padding: 5px;">` +
    langarr[46] +
    `:</label>
  ...
  sourceHTML +=
    `<br><br><center>
					<button type="submit" class="btn btn-sm btn-secondary" onclick="doUpdateSource(` +
    aSrc.id +
    `);" style="min-width: 100px;">` +
    langarr[49] +
    `</button>
					<button type="submit" class="btn btn-sm btn-secondary" onclick="doConfirm(` +
    aSrc.id +
    `);" style="min-width: 100px;">` +
    langarr[48] +
    `</button>
    ...
    for (i = 0; i < scheduledata.length; i++) {
      if (scheduledata[i].fmtargetid > "") {
        optval =
          scheduledata[i].id +
          " " +
          scheduledata[i].fmname +
          " TargetID: " +
          scheduledata[i].fmtargetid;
      } else {
        optval =
          scheduledata[i].id +
          " " +
...
function setPieSeries(theData, chartname) {
  ...
  for (i = 0; i < theData.length; i++) {
    ...
    if (tmptext == "Instagram") {
      theicon = fa_instagram;
    }
    if (tmptext == "Twitter") {
      theicon = fa_twitter;
    }
    ...
    if (tmptext == "VKontakte") {
      theicon = fa_vk;
    }
    if (tmptext == "RSS") {
      theicon = fa_rss;
    }
    if (tmptext == "NewsContent") {
      theicon = fa_newscontent;
    }
    if (tmptext == "WhatsApp") {
      theicon = fa_whatsapp;
    }
    ...
    if (chartname == "chart1") {
      legendHTML +=
        ...
        theData[i].doc_count +
        '" style="font-size: 12px;"><td class="square-social" style="' +
        dotstyle +
        '"></td><td>' +
        theicon +
        "</td><td>" +
...
function exportTable() {
  let mycsv =
    "ID,Time,Type,Pic URL,Name and ID,Content,Tags,Engagements,Sentiment,Link" +
    "\n";
  for (i = 0; i < rawdata.length; i++) {
    ...
    if (
      typeof rawdata[i].like_count !== "undefined" &&
      rawdata[i].like_count > "0"
    ) {
      rawdata[i].engagements = "Likes " + rawdata[i].like_count + " ";
    }
    if (
      typeof rawdata[i].comment_count !== "undefined" &&
      rawdata[i].comment_count > "0"
    ) {
      rawdata[i].engagements += "Comments " + rawdata[i].comment_count + " ";
    }
    rawdata[i].engagements += "\n";
    if (
      typeof rawdata[i].retweet_count !== "undefined" &&
      rawdata[i].retweet_count > "0"
    ) {
      rawdata[i].engagements += "Retweets " + rawdata[i].retweet_count + " ";
    }
    if (
      typeof rawdata[i].shared_count !== "undefined" &&
      rawdata[i].shared_count > "0"
    ) {
    ...
    mycsv +=
      ...
      tabcnt +
      '","' +
      rawdata[i].created_at +
      '","' +
      rawdata[i].social_network +
      '","' +
      rawdata[i].pic_url +
      '","' +
      rawdata[i].user_name +
      ...
      rawdata[i].engagements +
      '","' +
      rawdata[i].sentiment.replace("Natural", "Neutral") +
      '","' +
      rawdata[i].marker_url +
      '"' +
      "\n";
  }
